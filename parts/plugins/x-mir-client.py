...
class MirClientPlugin(snapcraft.BasePlugin):
...
# NOTE: the libmirclient is bundled as part of qtmir
# so, in the instance this is a template used for a
# native mir client app, libmirclient would need to be added
#            'libmirclient-dev',
            'qmlscene',
    ...
    def env(self, root):
        ...
        return [
            ...
            .format(root, arch),
            # XKB config
            'XKB_CONFIG_ROOT={}/usr/share/X11/xkb'.format(root),
